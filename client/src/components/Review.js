...
<div id="picture">
        ...
        <p>Career Devs Student, about to enter the Intermediate Level Class</p>
        <p>Happy to help with whatever I can</p>
      <div id="stars">
      </div>
...
<div id="picture">
        ...
        <h2>Jose M</h2>
        <p className="title">Full Stack Developer</p>
        <p>Back End Developer, experienced w/ Express & API's</p>
        <p>Leave me a Message and i'll reply ASAP</p>
        <div id="stars">
      </div>
        <p><button className="button1">Contact</button></p>
      </div>
...
<div id="picture">
        ...
        <h2>Nate K</h2>
        <p className="title">Full Stack Developer</p>
        <p>Full Stack Specialist, experienced with ReactJS & Express</p>
        <p>Happy to help anyone I can, Just leave me a message!</p>
        <div id="stars">
      </div>
        <p><button className="button1">Contact</button></p>
      </div>
...
<div id="picture">
        ...
        <h2>Louis F</h2>
        <p className="title">Full Stack Developer</p>
        <p>Full Stack WebDev, I enjoy working with React & MongoDB</p>
        <p>Send me a message and lets start coding!</p>
        <div id="stars">
      </div>
        <p><button className="button1">Contact</button></p>
      </div>
